#!/usr/bin/env python3
"""
Script to set up Cognito User Pool for operations Agent

This script creates a Cognito User Pool with authentication configuration
for the operations agent using the utility functions from utils.py.
"""
import sys
import json
import boto3
...
USER_POOL_NAME = "operations-agentcore-gateway-pool"
RESOURCE_SERVER_ID = "operations-agentcore-gateway-id"
RESOURCE_SERVER_NAME = "operations-agentcore-gateway-name"
CLIENT_NAME = "operations-agentcore-gateway-client"
SCOPES = [
...
def main():
    """
    Main function to set up Cognito User Pool for operations agent
    """
    logger.info("Starting Cognito User Pool setup for the operations Agent")
    ...
    try:
        ...
        print("="*60)
        print("Use these credentials to authenticate with the operations agent")
